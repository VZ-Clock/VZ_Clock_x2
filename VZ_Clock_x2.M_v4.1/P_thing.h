    ...
    <head>
        ...
        <script type = "text/javascript">
            function set_thing_ust(submit) {
                ...
                server += "&sendhum=" + val_sw('sendhum') + "&sendpress=" + val_sw('sendpress') + "&getThing=" + val_sw('getThing') + "&corrhumThink=" + val('corrhumThink');
    ...
    <body onload = "load_thing();">
        ...
        <central-unit>
            ...
            <div class="informer">
                ...
                <a href = "https://thingspeak.com" align = "center" target = "_blank">которые берем здесь</a> 
            </div>        
            <br>                
            <div id="main_unit">
            <center>                
                 ...
                 <br> 
                   ...
                   <table id="table__font" class = "table">
                        ...
                        <tr>
                            <td><input type="text" size="1" class="field form-control" id="corrhumThink" value="{{corrhumThink}}" pattern="\- \d+(\.\d{2})?"></td>
                            <td><span class="opt_cn"> {{humThinkd}} </span></td>
                        </tr>
                    </table>
                    <br>                  
                    <div class="informer">
