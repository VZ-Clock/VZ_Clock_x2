...
void handle_thing_ust() {
  ...
  if(server.arg("corrhumThink")!="") corrhumThink = server.arg("corrhumThink").toFloat();  
  if(printCom) {
    printTime();
...
void handle_setup(){
  ...
  if(server.arg("displayTime")!="") displayTime = server.arg("displayTime").toInt();
  ...
  if(server.arg("displayDot")!="") displayDot = server.arg("displayDot").toInt();
