    ...
    <head>
        ...
        <script type = "text/javascript">
            function set_setup(submit) {
                ...
                server += "&fontCLOCK=" + val('fontCLOCK') + "&aliData=" + val('aliData') + "&fontSizeCLOCK=" + val('fontSizeCLOCK') + "&fontSizeData=" + val('fontSizeData') + "&dataDown=" + val('dataDown') + "&textDown=" + val('textDown') + "&displayData=" + val('displayData') + "&displayDot=" + val('displayDot') + "&displayTime=" + val('displayTime');
        ...
        <central-unit>
            ...
            <div id="main_unit">
                <center>
                    ...
                    <table>
                        <tr>
                            <td align = "right"><span class="opt_cn">Отображение времени</span></td>
                            <td><select id = "displayTime">
                                <option value = "0"> ЧЧ:ММ</option>
                                <option value = "1"> ЧЧ:ММ:СС </option>
                            </select></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><select id = "displayDot">
                                <option value = "0"> Мигающие </option>
                                <option value = "1"> Прыгающие </option>
                            </select></td>
                        </tr>   
                        <tr>
